  ...
  <div class="home-container">
    <div class="home-navbar">
      ...
      <svg viewBox="0 0 950.8571428571428 1024" class="home-icon">
        ...
        ></path></svg
      ><svg viewBox="0 0 602.2582857142856 1024" class="home-icon02">
        <path
      ...
      <div class="home-hero-text-container">
        ...
        <div class="home-cta-btn-container">
          <button class="home-cta-btn Anchor button">
            <span class="home-text12">Get in Contact</span>
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="home-logo-container">
        <div class="home-container02">
          <img
            ...
            class="home-image"
          />
          <span class="home-text16">Estimated July 2023</span>
        </div>
        <div class="home-container03">
          <img
            ...
            class="home-image1"
          />
          <span class="home-text17">Estimated Nov. 2023</span>
        </div>
